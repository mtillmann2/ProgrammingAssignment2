...
## The first function, makeCacheMatrix, creates a special object, which is really 
...
## The following function calculates the inverse of the cached matrix created with
